...
-> 本目录是为 ShirohaPet 项目精简的 GPT-SoVITS TTS 推理引擎，仅保留了 TTS 推理所需的核心功能。
...
本项目作为 ShirohaPet 的子模块，依赖由根项目统一管理：

```bash
# 在项目根目录
cd /path/to/ShirohaPet-With-MPS
uv sync
```
...
**维护说明:** 此目录为 ShirohaPet 项目专用，如需完整功能请使用原始 GPT-SoVITS 项目。
